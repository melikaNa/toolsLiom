...
import sty from "./PlasmicSelfTest2.module.css"; // plasmic-import: dKxJpWkOSOVr/css
        ...
        >
          ...
          <HamdastAuth
            ...
            onSuccess={async authCode => {
              ...
              $steps["invokeGlobalAction"] = true
                ? (() => {
                    const actionArgs = {
                      args: [
                        "POST",
                        "https://n8n.staas.ir/webhook/pasiresh24/login",
                        undefined,
                        (() => {
                          try {
              ...
              $steps["updateData"] = $steps.invokeGlobalAction?.data?.success
                ? (() => {
                    const actionArgs = {
                      variable: {
                        objRoot: $state,
                ...
                ? (() => {
                    const actionArgs = {
                      args: [
                        ...
                        (() => {
                          try {
                            return { origin_user_id: $state.data.userId };
                          } catch (e) {
                            if (
                              e instanceof TypeError ||
                              e?.plasmicType === "PlasmicUndefinedDataError"
                            ...
                            try {
                              return {
                                ...
                                origin:
                                  ...
                                  "liomSite",
                                origin_user_id: $state.data.userId || "null"
                              };
                            } catch (e) {
                              if (
                                e instanceof TypeError ||
              ...
              $steps["runCode"] =
                $steps.updateTestChat2.data?.success == true ||
                $steps.invokeGlobalAction2?.data?.success == true
                  ? (() => {
                      const actionArgs = {
                        customFunction: async () => {
                          return localStorage.setItem(
                            "user_id",
                            $steps.updateTestChat2?.data?.user_id ||
                              $steps.invokeGlobalAction2?.data?.user_id
                          );
                        }
                      };
                      return (({ customFunction }) => {
          ...
          <div
            className={classNames(projectcss.all, sty.freeBox__bhpRh, ``)}
            id={"messegeBox"}
          >
            <Reveal
              big={false}
              cascade={false}
              className={classNames("__wab_instance", sty.reveal__espxp)}
              delay={0}
              direction={"up"}
              duration={1000}
              effect={"fade"}
          ...
          <div
            className={classNames(projectcss.all, sty.freeBox__oFiu, ``)}
            id={"selectBox"}
          >
            <Reveal
              big={true}
              className={classNames("__wab_instance", sty.reveal__r6Mks)}
              direction={"up"}
              triggerOnce={true}
            >
              {(() => {
                try {
                  return (
                    $state.testChat[$state.testChat.length - 1].options !=
                      null &&
                    !(
                      $state.variable.question.lock == 1 && $state.buy == false
                    ) &&
              ...
              {(
                ...
                >
                  <div
                    className={classNames(projectcss.all, sty.freeBox__fXmas)}
                  >
                    <div
                      className={classNames(projectcss.all, sty.freeBox__bQ8Bm)}
                    >
                      <div
                        className={classNames(
                          projectcss.all,
                    ...
                    <div
                      className={classNames(projectcss.all, sty.freeBox__m6EzX)}
                    >
                      <div
                        className={classNames(
                          projectcss.all,
                  ...
                  <ButtonLiom
                    ...
                    endIcon={
                      <Icon111Icon
                        className={classNames(projectcss.all, sty.svg__qX7W)}
                        role={"img"}
                      />
                    }
                    isDisabled={(() => {
              ...
              {(
                ...
                >
                  <div
                    className={classNames(projectcss.all, sty.freeBox__nM1WA)}
                  >
                    <div
                      className={classNames(projectcss.all, sty.freeBox___6LhL)}
                    >
                      <div
                        className={classNames(
                          projectcss.all,
                    ...
                    <div
                      className={classNames(projectcss.all, sty.freeBox__is8KK)}
                    >
                      <div
                        className={classNames(
                          projectcss.all,
                  ...
                  <Paziresh24Button
                    ...
                    className={classNames(
                      "__wab_instance",
                      sty.paziresh24Button__camzX
                    )}
                    endIcon={
                      <ChevronLeftIcon
                        className={classNames(projectcss.all, sty.svg___4Zf74)}
                        role={"img"}
                      />
                    }
                    loading={(() => {
                    ...
                    startIcon={
                      <ChevronRightIcon
                        className={classNames(projectcss.all, sty.svg__qFiiw)}
                        role={"img"}
                      />
                    }
                  />
              ...
              {(() => {
                ...
                <Stack__
                  as={"div"}
                  hasGap={true}
                  className={classNames(projectcss.all, sty.freeBox__lhTxt)}
                >
                  <Paziresh24Button
                    children2={
                      (() => {
                    ...
                    className={classNames(
                      "__wab_instance",
                      sty.paziresh24Button__jUdIl
                    )}
                    color={"green"}
                    endIcon={
                      <Icon111Icon
                        className={classNames(projectcss.all, sty.svg__gsak)}
                        role={"img"}
                      />
                    }
                    isDisabled={(() => {
                    ...
                    startIcon={
                      <ChevronRightIcon
                        className={classNames(projectcss.all, sty.svg__cbQud)}
                        role={"img"}
                      />
                    }
                  />
          ...
          {(() => {
            ...
            <div className={classNames(projectcss.all, sty.freeBox__h1BO, ``)}>
              <Reveal
                big={true}
                className={classNames("__wab_instance", sty.reveal__hpZwu)}
                direction={"up"}
                triggerOnce={true}
              >
                <Stack__
                  as={"div"}
                  hasGap={true}
                  className={classNames(projectcss.all, sty.freeBox__oQ0B8)}
                >
                  <ApiRequest
                    ...
                    onSuccess={async (...eventArgs: any) => {
                      ...
                      (async data => {
                        ...
                        $steps["updateStatus"] = (
                          $state.apiRequest2?.data?.statusBuy
                        ...
                        $steps["updateStatus2"] = (
                          ...
                          : undefined;
                        if (
                          $steps["updateStatus2"] != null &&
                          typeof $steps["updateStatus2"] === "object" &&
                          typeof $steps["updateStatus2"].then === "function"
                        ) {
                          $steps["updateStatus2"] = await $steps[
                            "updateStatus2"
                          ];
                        }
                      }).apply(null, eventArgs);
                          ...
                          <ButtonLiom
                            ...
                            onClick={async event => {
                              ...
                              if (
                                $steps["updateStatus"] != null &&
                                typeof $steps["updateStatus"] === "object" &&
                                typeof $steps["updateStatus"].then ===
                                  "function"
                              ) {
          ...
          {(() => {
            ...
            <div className={classNames(projectcss.all, sty.freeBox__n1Lzn)}>
              <ApiRequest
          ...
          {(() => {
            ...
            <div className={classNames(projectcss.all, sty.freeBox___48UvI)}>
              {(() => {
                try {
                  return (() => {
                ...
                <Icon111Icon
                  className={classNames(projectcss.all, sty.svg__iLixw)}
                  role={"img"}
                />
              ) : null}
              {(() => {
                ...
                <Icon111Icon
                  className={classNames(projectcss.all, sty.svg__xoXsY)}
                  role={"img"}
                />
              ) : null}
            </div>
            ...
            onLoading={async (...eventArgs: any) => {
              ...
              (async loading => {
                ...
                $steps["updateShowgreen"] = true
                  ? (() => {
                      const actionArgs = {
                        ...
                        operation: 0,
                        value: $steps.invokeGlobalAction5?.data?.data || []
                      };
                      return (({
                        variable,
                        value,
                ...
                if (
                  ...
                  $steps["updateShowgreen"] = await $steps["updateShowgreen"];
                }
          ...
          <Paziresh24Dialog
            ...
            body={
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__zx3JW)}
              >
                {(_par => (!_par ? [] : Array.isArray(_par) ? _par : [_par]))(
                  (() => {
                    try {
...
const PlasmicDescendants = {
  ...
  hamdastProvider: ["hamdastProvider"],
