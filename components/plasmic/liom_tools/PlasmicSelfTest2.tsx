              ...
              return [
                {
                  ...
                  session_id: 17645,
                  user_id: 19738,
                  origin_user_id: "765dbece-3d21-42ce-89a7-5243c4b10eff",
                  text: "چطوری میتونم بفهمم دلیل قاعدگی نامنظمم چیه \n",
                  isBot: 0,
                  timestamp: "2025-08-09 08:49:41"
                },
                {
                  id: 66865,
                  session_id: 17645,
                  user_id: 19738,
                  origin_user_id: "765dbece-3d21-42ce-89a7-5243c4b10eff",
                  text: '{\n  "text": "قاعدگی‌های نامنظم می‌تواند به دلایل مختلفی باشد مثل استرس، تغییرات وزن، مشکلات هورمونی یا بیماری‌هایی مانند تنبلی تخمدان. برای اینکه دلیل نامنظمی قاعدگی‌تان را بهتر بشناسید و بررسی‌های علمی‌تر داشته باشید، می‌توانید از ابزار «تشخیص دلیل نامنظمی پریود» لیوم استفاده کنید. این ابزار به شما کمک می‌کند علت احتمالی را پیدا کنید و راهنمایی مناسبی بگیرید.",\n  "cta": "برای بررسی دلیل نامنظمی قاعدگی روی دکمه زیر کلیک کنید👇🏻",\n  "btnText": "تشخیص دلیل نامنظمی پریود",\n  "action": "irregular"\n}',
                  isBot: 1,
                  timestamp: "2025-08-09 08:49:41"
                },
                {
