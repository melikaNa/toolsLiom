...
import sty from "./PlasmicTextInput2.module.css"; // plasmic-import: GNjiMipwx0dm/css
...
function PlasmicTextInput2__RenderFunc(props: {
  ...
  return (
    <div
      ...
      className={classNames(
        ...
        sty.root,
        {
          ...
          [sty.rooterror_isDisabled]:
            hasVariant($state, "isDisabled", "isDisabled") &&
            hasVariant($state, "error", "error"),
          [sty.rootisDisabled]: hasVariant($state, "isDisabled", "isDisabled"),
          [sty.rootisDisabled____focusVisibleWithin]:
            hasVariant($state, "isDisabled", "isDisabled") &&
            triggers.focusVisibleWithin_root,
          [sty.rootshowEndIcon____focusVisibleWithin]:
            hasVariant($state, "showEndIcon", "showEndIcon") &&
            triggers.focusVisibleWithin_root,
          [sty.rootshowEndIcon_isDisabled____focusVisibleWithin]:
            hasVariant($state, "showEndIcon", "showEndIcon") &&
            hasVariant($state, "isDisabled", "isDisabled") &&
            triggers.focusVisibleWithin_root,
          [sty.rootshowEndIcon_showStartIcon____focusVisibleWithin]:
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__ovRjf, {
          [sty.freeBoxerror__ovRjfGhayA]: hasVariant($state, "error", "error"),
          [sty.freeBoxsize_medium__ovRjfiRjRs]: hasVariant(
            $state,
            "size",
            "medium"
          ),
          [sty.freeBoxsize_short__ovRjFynzti]: hasVariant(
            $state,
            "size",
            "short"
          )
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__vBhwd, {
          [sty.freeBox___focusVisibleWithin__vBhwdrx4D]:
            triggers.focusVisibleWithin_root,
          [sty.freeBoxcolor_dark__vBhwdaE9C5]: hasVariant(
            $state,
            "color",
            "dark"
          ),
          [sty.freeBoxerror__vBhwdGhayA]: hasVariant($state, "error", "error"),
          [sty.freeBoxisDisabled__vBhwdjx7Li]: hasVariant(
            $state,
            "isDisabled",
            "isDisabled"
          ),
          [sty.freeBoxshowStartIcon__vBhwdl8O0D]: hasVariant(
            $state,
            "showStartIcon",
            "showStartIcon"
          ),
          [sty.freeBoxsize_longh__vBhwdA0Gw6]: hasVariant(
            $state,
            "size",
            "longh"
          ),
          [sty.freeBoxsize_medium__vBhwdIRjRs]: hasVariant(
            $state,
            "size",
            "medium"
          )
      ...
      >
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <SearchSvgIcon
                className={classNames(projectcss.all, sty.svg__wC7Va)}
                role={"img"}
              />
            ),
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CheckSvgIcon
                className={classNames(projectcss.all, sty.svg__iqVy)}
                role={"img"}
              />
            ),
...
const PlasmicDescendants = {
  root: ["root", "startIconContainer", "input", "endIconContainer", "text"],
