...
import sty from "./PlasmicDialog.module.css"; // plasmic-import: XbG3MnD64yeT/css
...
function PlasmicDialog__RenderFunc(props: {
  ...
  return (
    <Dialog
      ...
      overlayClassName={classNames({ [sty["pcls_O2OSH4OWgaW9"]]: true })}
