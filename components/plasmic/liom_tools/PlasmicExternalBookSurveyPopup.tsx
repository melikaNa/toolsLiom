...
import sty from "./PlasmicExternalBookSurveyPopup.module.css"; // plasmic-import: Uv6Ny2EftKLb/css
                  ...
                  customFunction: async () => {
                    return (function () {
                      var createFullScreenPopup = function (url) {
                        ...
                        var closeTextButton = document.createElement("button");
