...
import sty from "./PlasmicEntryPrescription2.module.css"; // plasmic-import: WxT165Ksio_2/css
...
export type PlasmicEntryPrescription2__VariantMembers = {};
export type PlasmicEntryPrescription2__VariantsArgs = {};
type VariantPropType = keyof PlasmicEntryPrescription2__VariantsArgs;
export const PlasmicEntryPrescription2__VariantProps =
  new Array<VariantPropType>();

export type PlasmicEntryPrescription2__ArgsType = {
  id?: number;
...
export interface DefaultEntryPrescription2Props {
  id?: number;
  onIdChange?: (val: string) => void;
  sessionId?: number;
  title?: string;
...
function PlasmicEntryPrescription2__RenderFunc(props: {
  variants: PlasmicEntryPrescription2__VariantsArgs;
  args: PlasmicEntryPrescription2__ArgsType;
  overrides: PlasmicEntryPrescription2__OverridesType;
  forNode?: string;
}) {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__xyZ4)}>
        <div className={classNames(projectcss.all, sty.freeBox__umQhC)}>
          <TextInput
      ...
      <section className={classNames(projectcss.all, sty.section__ivhcv)}>
        {(() => {
          try {
            return (
          ...
          >
            ...
            >
              <React.Fragment>
                {(() => {
                  try {
                    return `ثبت اطلاعات نسخه ${$state.title}`;
                  } catch (e) {
                    if (
                      e instanceof TypeError ||
                      e?.plasmicType === "PlasmicUndefinedDataError"
                    ) {
                      return "\u062b\u0628\u062a \u0627\u0637\u0644\u0627\u0639\u0627\u062a \u0646\u0633\u062e\u0647";
                    }
                    throw e;
                  }
                })()}
      ...
      <section className={classNames(projectcss.all, sty.section__vcwV)}>
        <div className={classNames(projectcss.all, sty.freeBox__eLn4A)}>
          <ButtonLiom
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicEntryPrescription2__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicEntryPrescription2__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    // Specify args directly as props
    Omit<PlasmicEntryPrescription2__ArgsType, ReservedPropsType> &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicEntryPrescription2__ArgProps,
          internalVariantPropNames: PlasmicEntryPrescription2__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicEntryPrescription2__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicEntryPrescription2";
  } else {
    func.displayName = `PlasmicEntryPrescription2.${nodeName}`;
  }
  return func;
}

export const PlasmicEntryPrescription2 = Object.assign(
  // Top-level PlasmicEntryPrescription2 renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicEntryPrescription2
    internalVariantProps: PlasmicEntryPrescription2__VariantProps,
    internalArgProps: PlasmicEntryPrescription2__ArgProps
  }
);

export default PlasmicEntryPrescription2;
/* prettier-ignore-end */
