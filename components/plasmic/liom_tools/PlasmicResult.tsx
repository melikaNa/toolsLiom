              ...
              {(() => {
                ...
                >
                  <React.Fragment>
                    <React.Fragment>
                      {
                        "\u0645\u0634\u06a9\u0644\u062a \u062c\u062f\u06cc \u0646\u06cc\u0633\u062a\u060c \u0627\u06af\u0647 \u0646\u06a9\u0627\u062a\u06cc \u06a9\u0647 \u062a\u0648 \u0628\u062e\u0634"
                      }
                    </React.Fragment>
                    <span
                    ...
                    <React.Fragment>
                      {
                        " \u06af\u0641\u062a\u0647 \u0634\u062f\u0647 \u0631\u0648 \u0631\u0639\u0627\u06cc\u062a \u06a9\u0646\u06cc\u060c \u062e\u0648\u0628 \u0645\u06cc\u200c\u0634\u06cc."
                      }
                    </React.Fragment>
                  </React.Fragment>
                </div>
                        ...
                        {(() => {
                          ...
                          >
                            {(() => {
                              ...
                              <Paziresh24Button
                                data-plasmic-name={"testTakmily2"}
                                data-plasmic-override={overrides.testTakmily2}
                                children2={
                                  <div
                                    className={classNames(
                                      projectcss.all,
          ...
          {(() => {
            ...
            >
              ...
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox___64XU)}
              >
                {(_par => (!_par ? [] : Array.isArray(_par) ? _par : [_par]))(
                  (() => {
                    try {
              ...
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox___1ESl1)}
              >
                <div
                  className={classNames(
                    projectcss.all,
              ...
              <Paziresh24Dialog
                ...
                body={
                  (() => {
                    ...
                    <Stack__
                      as={"div"}
                      hasGap={true}
                      className={classNames(projectcss.all, sty.freeBox__yXv86)}
                    >
                      <Stack__
                        as={"div"}
                        hasGap={true}
                            ...
                            <Star2
                              ...
                              onClick={async event => {
                                ...
                                if (
                                  $steps["updateRate"] != null &&
                                  typeof $steps["updateRate"] === "object" &&
                                  typeof $steps["updateRate"].then ===
                                    "function"
                                ) {
                                  $steps["updateRate"] = await $steps[
                                    "updateRate"
                                  ];
                                }
                              }}
                      ...
                      <Paziresh24Button
                        ...
                        onClick={async event => {
                          ...
                          if (
                            ...
                            $steps["updateLoadbtn"] = await $steps[
                              "updateLoadbtn"
                            ];
                          }
                ...
                trigger={
                  <Paziresh24Button
                    ...
                    className={classNames(
                      "__wab_instance",
                      sty.paziresh24Button__fadE
                    )}
                    endIcon={
                      <ChevronLeftIcon
                        className={classNames(projectcss.all, sty.svg__mDhoq)}
                        role={"img"}
                      />
                    }
                    outline={true}
                    ...
                    startIcon={
                      <ChevronRightIcon
                        className={classNames(projectcss.all, sty.svg__cZwBo)}
                        role={"img"}
                      />
                    }
                  />
          ...
          {(() => {
            ...
            >
              ...
              >
                {(() => {
                  try {
                    return $state.apiRequest.data.details.some(
                      item => item.advice_text != null && item.action != ""
                    );
                  } catch (e) {
                    if (
                      e instanceof TypeError ||
