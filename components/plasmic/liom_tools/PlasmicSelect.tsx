...
import MenuPopover from "../../MenuPopover"; // plasmic-import: pSBZTjbJHcwD/component
import MenuItem from "../../MenuItem"; // plasmic-import: qBbuWys2VSyE/component
import MenuSection from "../../MenuSection"; // plasmic-import: Yq3uesQyYshc/component
...
import sty from "./PlasmicSelect.module.css"; // plasmic-import: wNAAJ0eGxAP6/css
        ...
        menuItems={renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              ...
              <MenuSection
                className={classNames("__wab_instance", sty.menuSection__dD5Zd)}
                header={
                  <div
                    className={classNames(
                      projectcss.all,
