...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: qBbuWys2VSyE/css
...
function PlasmicMenuItem__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox___7TIt0)}>
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__ya6EM)}>
            <div
              className={classNames(
                projectcss.all,
