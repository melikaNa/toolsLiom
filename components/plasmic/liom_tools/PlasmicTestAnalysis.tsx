            ...
            <div className={classNames(projectcss.all, sty.freeBox___4Myrl)}>
                                    ...
                                    const actionArgs = {
                                      customFunction: async () => {
                                        return (() => {
                                          ...
                                          var link = `https://tools.liom.app/chat-bot/?question=${question}&attachments=${attachments}&inApp=${$state.paramsObject.inApp}&prompt=${prompt}`;
              ...
              <div
                ...
                onClick={async event => {
                  ...
                  $steps["notCredit"] = !$state.enoughCredit
                    ? (() => {
                        const actionArgs = {
                          args: [
                            "error",
                  ...
                  $steps["runCode2"] = !$state.enoughCredit
                    ? (() => {
                        const actionArgs = {
                          customFunction: async () => {
                            return (() => {
