...
import sty from "./PlasmicResultComponnent.module.css"; // plasmic-import: YDl4w76xpMa9/css
...
export type PlasmicResultComponnent__VariantMembers = {
  information: "information";
  dercentage: "dercentage";
  specialized: "specialized";
};
export type PlasmicResultComponnent__VariantsArgs = {
...
type VariantPropType = keyof PlasmicResultComponnent__VariantsArgs;
export const PlasmicResultComponnent__VariantProps = new Array<VariantPropType>(
  "information",
  "dercentage",
  "specialized"
);

export type PlasmicResultComponnent__ArgsType = {
  userId?: string;
...
type ArgPropType = keyof PlasmicResultComponnent__ArgsType;
export const PlasmicResultComponnent__ArgProps = new Array<ArgPropType>(
  "userId",
  "onUserIdChange",
  "sessionId",
  "onSessionIdChange",
...
export type PlasmicResultComponnent__OverridesType = {
  root?: Flex__<"div">;
...
export interface DefaultResultComponnentProps {
  userId?: string;
  onUserIdChange?: (val: string) => void;
  sessionId?: string;
  onSessionIdChange?: (val: string) => void;
...
function PlasmicResultComponnent__RenderFunc(props: {
  variants: PlasmicResultComponnent__VariantsArgs;
  args: PlasmicResultComponnent__ArgsType;
  overrides: PlasmicResultComponnent__OverridesType;
  forNode?: string;
}) {
  ...
  const stateSpecs: Parameters<typeof useDollarState>[0] = React.useMemo(
    () => [
      ...
      },
      {
        ...
        valueProp: "sessionId",
        onChangeProp: "onSessionIdChange"
      }
    ],
    [$props, $ctx, $refs]
  );
  ...
  return (
    <div
      ...
      className={classNames(
        ...
        sty.root,
        {
          [sty.rootdercentage]: hasVariant($state, "dercentage", "dercentage"),
          ...
          [sty.rootspecialized_dercentage]:
              ...
              const actionArgs = {
                args: [
                  ...
                  (() => {
                    try {
                      return {
                        userId: new window.URLSearchParams(
    ...
    >
      {(() => {
        try {
          return $state.level == 3 && !$state.apiRequest.loading ? false : true;
        } catch (e) {
          if (
            e instanceof TypeError ||
            e?.plasmicType === "PlasmicUndefinedDataError"
        ...
        >
          <div
            ...
            className={classNames(projectcss.all, sty.loading2, {
              [sty.loading2specialized]: hasVariant(
                $state,
                "specialized",
                "specialized"
              )
          ...
          >
            <div className={classNames(projectcss.all, sty.freeBox__xB7Tf)}>
              {(() => {
                try {
                  return (
                    new window.URLSearchParams(
                      new window.URL(window.location.href).search
                    ).get("Share") != "true"
                  );
                } catch (e) {
                  if (
                ...
                <Reveal
                  big={false}
                  cascade={false}
                  className={classNames("__wab_instance", sty.reveal__uttZa)}
                  direction={"up"}
                  effect={"fade"}
                  triggerOnce={false}
                >
              ...
              {(() => {
                ...
                <Reveal
                  big={false}
                  cascade={false}
                  className={classNames("__wab_instance", sty.reveal__k287H)}
                  direction={"up"}
                  effect={"fade"}
                  triggerOnce={false}
                >
            ...
            <div className={classNames(projectcss.all, sty.freeBox___7ZbDm)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
      ...
      <section className={classNames(projectcss.all, sty.section__s1CO3)}>
        {(() => {
          try {
            return (
          ...
          <HeaderLiom
            ...
            slot={
              <React.Fragment>
                {(() => {
                  ...
                  <XIcon
                    className={classNames(projectcss.all, sty.svg__mMpmb)}
                    onClick={async event => {
                      const $steps = {};
                ...
                <Paziresh24Avatar
                  className={classNames(
                    "__wab_instance",
                    sty.paziresh24Avatar__i9Mv6,
                    {
                      [sty.paziresh24Avatarspecialized__i9Mv68RZr3]: hasVariant(
                        $state,
                        "specialized",
                        "specialized"
                      )
            ...
            slot2={null}
          >
            <div className={classNames(projectcss.all, sty.freeBox___1Gky7)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
      ...
      <div className={classNames(projectcss.all, sty.freeBox__r1CUy)}>
        <Paziresh24Button
          className={classNames("__wab_instance", sty.paziresh24Button__symxN)}
          endIcon={
            <ChevronLeftIcon
              className={classNames(projectcss.all, sty.svg__buvco)}
              role={"img"}
            />
          }
          startIcon={
            <ChevronRightIcon
              className={classNames(projectcss.all, sty.svg__pUlT0)}
              role={"img"}
            />
          }
        />
      ...
      {(() => {
        try {
          return $state.apiRequest.data && $state.apiRequest.data.our_message;
        } catch (e) {
          if (
            e instanceof TypeError ||
            e?.plasmicType === "PlasmicUndefinedDataError"
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__inAnE, {
            [sty.freeBoxinformation__inAnEnqecg]: hasVariant(
              $state,
              "information",
              "information"
            ),
            [sty.freeBoxspecialized__inAnE8RZr3]: hasVariant(
              $state,
              "specialized",
              "specialized"
            )
        ...
        >
          ...
          <div
            className={classNames(projectcss.all, sty.freeBox__k2Voh, {
              [sty.freeBoxdercentage__k2VohHpnJh]: hasVariant(
                $state,
                "dercentage",
                "dercentage"
              ),
              [sty.freeBoxinformation__k2VohNqecg]: hasVariant(
                $state,
                "information",
                "information"
              )
          ...
          >
            {(_par => (!_par ? [] : Array.isArray(_par) ? _par : [_par]))(
              ...
              return (
                <div
                  className={classNames(projectcss.all, sty.freeBox__kLpkC, {
                    [sty.freeBoxdercentage__kLpkChpnJh]: hasVariant(
                      $state,
                      "dercentage",
                      "dercentage"
                    ),
                    [sty.freeBoxinformation__kLpkCnqecg]: hasVariant(
                      $state,
                      "information",
                      "information"
                    )
                  ...
                  {(() => {
                    ...
                    <div
                      className={classNames(
                        ...
                        sty.freeBox___44Mp,
                        {
                          [sty.freeBoxdercentage___44MphpnJh]: hasVariant(
                            $state,
                            "dercentage",
                            "dercentage"
                          ),
                          [sty.freeBoxinformation___44Mpnqecg]: hasVariant(
                            $state,
                            "information",
                            "information"
                          ),
                          [sty.freeBoxspecialized___44Mp8RZr3]: hasVariant(
                            $state,
                            "specialized",
                            "specialized"
                          )
                    ...
                    >
                      <div
                        className={classNames(
                          ...
                          sty.freeBox__yTmpe,
                          {
                            [sty.freeBoxinformation__yTmpenqecg]: hasVariant(
                              $state,
                              "information",
                              "information"
                            )
                      ...
                      >
                        <div
                          className={classNames(
                            ...
                            sty.freeBox__m9Emj,
                            {
                              [sty.freeBoxinformation__m9Emjnqecg]: hasVariant(
                                $state,
                                "information",
                                "information"
                              )
                        ...
                        >
                          <div
                            className={classNames(
                              ...
                              sty.text__ezDb7,
                              {
                                [sty.textdercentage__ezDb7HpnJh]: hasVariant(
                                  $state,
                                  "dercentage",
                                  "dercentage"
                                )
                          ...
                          {(
                            ...
                            <PercentageBox
                              className={classNames(
                                "__wab_instance",
                                sty.percentageBox__cSw8,
                                {
                                  [sty.percentageBoxinformation__cSw8Nqecg]:
                                    hasVariant(
                                      $state,
                                      "information",
                                      "information"
                            ...
                            >
                              <div
                                className={classNames(
                                  ...
                                  sty.text__fsHnp,
                                  {
                                    [sty.textdercentage__fsHnpHpnJh]:
                                      hasVariant(
                                        $state,
                                        "dercentage",
                                        "dercentage"
                                      ),
                                    [sty.textinformation__fsHnpNqecg]:
                                      hasVariant(
                                        $state,
                                        "information",
                                        "information"
                          ...
                          expandIcon: (
                            <React.Fragment>
                              {(() => {
                                ...
                                <PlasmicImg__
                                  alt={""}
                                  className={classNames(sty.img__vJun9)}
                                  displayHeight={"auto"}
                              ...
                              {(() => {
                                ...
                                <PlasmicImg__
                                  alt={""}
                                  className={classNames(sty.img__hsu9T)}
                                  displayHeight={"auto"}
                                  displayMaxHeight={"none"}
                                  displayMaxWidth={"100%"}
                                  displayMinHeight={"0"}
                  ...
                  {(
                    ...
                    <div
                      className={classNames(
                        ...
                        sty.text___7I9Ra,
                        {
                          [sty.textinformation___7I9RaNqecg]: hasVariant(
                            $state,
                            "information",
                            "information"
                          )
            ...
            {(() => {
              ...
              <div
                className={classNames(projectcss.all, sty.freeBox__iFqeR, {
                  [sty.freeBoxdercentage__iFqeRhpnJh]: hasVariant(
                    $state,
                    "dercentage",
                    "dercentage"
                  ),
                  [sty.freeBoxinformation__iFqeRnqecg]: hasVariant(
                    $state,
                    "information",
                    "information"
                  ),
                  [sty.freeBoxspecialized__iFqeR8RZr3]: hasVariant(
                    $state,
                    "specialized",
                    "specialized"
                  )
              ...
              >
                ...
                <ChevronDownIcon
                  className={classNames(projectcss.all, sty.svg__gAin9)}
                  role={"img"}
                />
              </div>
            ) : null}
            {(() => {
              ...
              <div
                className={classNames(projectcss.all, sty.freeBox__naSBy, {
                  [sty.freeBoxdercentage__naSByHpnJh]: hasVariant(
                    $state,
                    "dercentage",
                    "dercentage"
                  ),
                  [sty.freeBoxinformation__naSByNqecg]: hasVariant(
                    $state,
                    "information",
                    "information"
                  )
              ...
              >
                ...
                <ChevronUpIcon
                  className={classNames(projectcss.all, sty.svg__h2C)}
                  role={"img"}
                />
              </div>
            ) : null}
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__ruaD, {
          [sty.freeBoxspecialized__ruaD8RZr3]: hasVariant(
            $state,
            "specialized",
            "specialized"
          )
      ...
      >
        <div
          className={classNames(
            ...
            sty.text__chWVq,
            {
              [sty.textspecialized__chWVq8RZr3]: hasVariant(
                $state,
                "specialized",
                "specialized"
              )
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__l1BLz, {
            [sty.freeBoxspecialized__l1BLz8RZr3]: hasVariant(
              $state,
              "specialized",
              "specialized"
            )
        ...
        >
          <div
            className={classNames(
              ...
              sty.text__a0Uqx,
              {
                [sty.textspecialized__a0Uqx8RZr3]: hasVariant(
                  $state,
                  "specialized",
                  "specialized"
                )
      ...
      {(
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__pPdlA, {
            [sty.freeBoxinformation__pPdlAnqecg]: hasVariant(
              $state,
              "information",
              "information"
            ),
            [sty.freeBoxspecialized__pPdlA8RZr3]: hasVariant(
              $state,
              "specialized",
              "specialized"
            )
        ...
        >
          <div
            className={classNames(
              ...
              sty.text__bensX,
              {
                [sty.textspecialized__bensX8RZr3]: hasVariant(
                  $state,
                  "specialized",
                  "specialized"
                )
          ...
          <div
            className={classNames(
              ...
              sty.text__pl2U6,
              {
                [sty.textspecialized__pl2U68RZr3]: hasVariant(
                  $state,
                  "specialized",
                  "specialized"
                )
          ...
          {(_par => (!_par ? [] : Array.isArray(_par) ? _par : [_par]))(
            ...
            return (
              <div
                className={classNames(projectcss.all, sty.freeBox__gHwMd, {
                  [sty.freeBoxspecialized__gHwMd8RZr3]: hasVariant(
                    $state,
                    "specialized",
                    "specialized"
                  )
              ...
              >
                <div
                  className={classNames(projectcss.all, sty.freeBox__b2OUz, {
                    [sty.freeBoxspecialized__b2OUz8RZr3]: hasVariant(
                      $state,
                      "specialized",
                      "specialized"
                    )
                ...
                >
                  <div
                    className={classNames(projectcss.all, sty.freeBox__lC1V6, {
                      [sty.freeBoxspecialized__lC1V68RZr3]: hasVariant(
                        $state,
                        "specialized",
                        "specialized"
                      )
                  ...
                  >
                    <Icons
                      ...
                      className={classNames(
                        ...
                        sty.icons___3RCo3,
                        {
                          [sty.iconsspecialized___3RCo38RZr3]: hasVariant(
                            $state,
                            "specialized",
                            "specialized"
                          )
                    ...
                    <PercentageBox
                      className={classNames(
                        "__wab_instance",
                        sty.percentageBox__cwve3,
                        {
                          [sty.percentageBoxspecialized__cwve38RZr3]:
                            hasVariant($state, "specialized", "specialized")
                        }
                      )}
                      shape={"square"}
                    ...
                    >
                      <div
                        className={classNames(
                          ...
                          sty.text__v4Xzn,
                          {
                            [sty.textspecialized__v4Xzn8RZr3]: hasVariant(
                              $state,
                              "specialized",
                              "specialized"
                            )
                      ...
                      <div
                        className={classNames(
                          ...
                          sty.text__rf5Su,
                          {
                            [sty.textspecialized__rf5Su8RZr3]: hasVariant(
                              $state,
                              "specialized",
                              "specialized"
                            )
                  ...
                  {(() => {
                    ...
                    <div
                      className={classNames(
                        ...
                        sty.freeBox__amLmv,
                        {
                          [sty.freeBoxspecialized__amLmv8RZr3]: hasVariant(
                            $state,
                            "specialized",
                            "specialized"
                          )
                    ...
                    >
                      {(
                        ...
                        <Paziresh24Button
                            ...
                            >
                              <div
                                className={classNames(
                                  ...
                                  {
                                    [sty.textspecialized__yQ8E8RZr3]:
                                      hasVariant(
                                        $state,
                                        "specialized",
                                        "specialized"
                          ...
                          className={classNames(
                            "__wab_instance",
                            sty.paziresh24Button___7Zw1Z,
                            {
                              [sty.paziresh24Buttonspecialized___7Zw1Z8RZr3]:
                                hasVariant($state, "specialized", "specialized")
                            }
                          )}
                          endIcon={
                          ...
                          onClick={async event => {
                            ...
                            $steps["updateRequestP"] = true
                              ? (() => {
                                  const actionArgs = {
                                    ...
                                    operation: 0,
                                    value: currentItem.actionBtnTxt.includes(
                                      "آزمایش"
                                    )
                                      ? "نسخه آزمایش"
                                      : "نسخه دارو"
                            ...
                            if (
                              ...
                              $steps["updateRequestP"] =
                                await $steps["updateRequestP"];
                            }
                          }}
                          outline={
                            hasVariant($state, "specialized", "specialized")
                  ...
                  {(
                    ...
                    <div
                      className={classNames(
                        ...
                        sty.freeBox__q5HLv,
                        {
                          [sty.freeBoxspecialized__q5HLv8RZr3]: hasVariant(
                            $state,
                            "specialized",
                            "specialized"
                          )
                    ...
                    >
                      {(
                        ...
                        <Paziresh24Button
                            ...
                            >
                              <div
                                className={classNames(
                                  ...
                                  {
                                    [sty.textspecialized___2BVz8RZr3]:
                                      hasVariant(
                                        $state,
                                        "specialized",
                                        "specialized"
                          ...
                          className={classNames(
                            "__wab_instance",
                            sty.paziresh24Button__zDr3,
                            {
                              [sty.paziresh24Buttonspecialized__zDr38RZr3]:
                                hasVariant($state, "specialized", "specialized")
                            }
                          )}
                          color={
                            ...
                            $steps["runCode"] = $state.prescriptions.find(
                              ...
                              ? (() => {
                                  const actionArgs = {
                                    customFunction: async () => {
                                      return window.open(
                                        `https://tools.liom.app/medicine/?code=${$state.prescriptions.find(i => i.request_p == $state.requestP && i.done == 1).doctor_tracking_code}`,
                                        "_self"
                                      );
                                    }
                                  };
                          ...
                          startIcon={
                            <Icon145Icon
                              className={classNames(
                                ...
                                sty.svg__gqoZg,
                                {
                                  [sty.svgspecialized__gqoZg8RZr3]: hasVariant(
                                    $state,
                                    "specialized",
                                    "specialized"
                                  )
                  ...
                  <div
                    className={classNames(projectcss.all, sty.freeBox__oo8L9, {
                      [sty.freeBoxspecialized__oo8L98RZr3]: hasVariant(
                        $state,
                        "specialized",
                        "specialized"
                      )
                  ...
                  >
                    <HamdastUtilsOpenLink
                      className={classNames(
                        "__wab_instance",
                        sty.hamdastUtilsOpenLink__n8Pc6,
                        {
                          [sty.hamdastUtilsOpenLinkspecialized__n8Pc68RZr3]:
                            hasVariant($state, "specialized", "specialized")
                        }
                      )}
                      destination={(() => {
          ...
          {(_par => (!_par ? [] : Array.isArray(_par) ? _par : [_par]))(
            ...
            return (
              <div
                className={classNames(projectcss.all, sty.freeBox__n01G6, {
                  [sty.freeBoxspecialized__n01G68RZr3]: hasVariant(
                    $state,
                    "specialized",
                    "specialized"
                  )
              ...
              >
                <div
                  className={classNames(projectcss.all, sty.freeBox__eS1X, {
                    [sty.freeBoxspecialized__eS1X8RZr3]: hasVariant(
                      $state,
                      "specialized",
                      "specialized"
                    )
                ...
                >
                  <div
                    className={classNames(projectcss.all, sty.freeBox__aKvMi, {
                      [sty.freeBoxspecialized__aKvMi8RZr3]: hasVariant(
                        $state,
                        "specialized",
                        "specialized"
                      )
                  ...
                  >
                    <Icons
                      apiRequestData={$state.apiRequestData}
                      className={classNames("__wab_instance", sty.icons__xcCe4)}
                      currentItem={currentItem}
                      unnamedGroupOfVariants={(() => {
                        try {
                          return (() => {
                    ...
                    {(() => {
                      ...
                      <PercentageBox
                        className={classNames(
                          "__wab_instance",
                          sty.percentageBox___6O4My,
                          {
                            [sty.percentageBoxspecialized___6O4My8RZr3]:
                              hasVariant($state, "specialized", "specialized")
                          }
                        )}
                        shape={"square"}
                      ...
                      >
                        <div
                          className={classNames(
                            ...
                            sty.text__n3FiT,
                            {
                              [sty.textspecialized__n3FiT8RZr3]: hasVariant(
                                $state,
                                "specialized",
                                "specialized"
                              )
                        ...
                        <div
                          className={classNames(
                            ...
                            sty.text__fd38C,
                            {
                              [sty.textspecialized__fd38C8RZr3]: hasVariant(
                                $state,
                                "specialized",
                                "specialized"
                              )
                  ...
                  {(() => {
                    ...
                    <div
                      className={classNames(projectcss.all, sty.freeBox__oELg, {
                        [sty.freeBoxspecialized__oELg8RZr3]: hasVariant(
                          $state,
                          "specialized",
                          "specialized"
                        )
                    ...
                    >
                      {(() => {
                        ...
                        <Paziresh24Button
                          ...
                          className={classNames(
                            "__wab_instance",
                            sty.paziresh24Button__mdzZh,
                            {
                              [sty.paziresh24Buttonspecialized__mdzZh8RZr3]:
                                hasVariant($state, "specialized", "specialized")
                            }
                          )}
                          endIcon={
                  ...
                  {(() => {
                    ...
                    <div
                      className={classNames(
                        ...
                        sty.freeBox__nk6Nh,
                        {
                          [sty.freeBoxspecialized__nk6Nh8RZr3]: hasVariant(
                            $state,
                            "specialized",
                            "specialized"
                          )
                    ...
                    >
                      <HamdastUtilsOpenLink
                        className={classNames(
                          "__wab_instance",
                          sty.hamdastUtilsOpenLink__i6WYk,
                          {
                            [sty.hamdastUtilsOpenLinkspecialized__i6WYk8RZr3]:
                              hasVariant($state, "specialized", "specialized")
                          }
                        )}
                        destination={(() => {
                          ...
                          ? (() => {
                              const child$Props = {
                                className: classNames(
                                  ...
                                  sty.buttonLiom4,
                                  {
                                    [sty.buttonLiom4specialized]: hasVariant(
                                      $state,
                                      "specialized",
                                      "specialized"
                                    )
      ...
      {(
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__iv5VV, {
            [sty.freeBoxinformation__iv5VVnqecg]: hasVariant(
              $state,
              "information",
              "information"
            ),
            [sty.freeBoxspecialized__iv5VV8RZr3]: hasVariant(
              $state,
              "specialized",
              "specialized"
            )
        ...
        >
          <div className={classNames(projectcss.all, sty.freeBox___6Qf6L)}>
            <div
              className={classNames(
                projectcss.all,
                projectcss.__wab_text,
          ...
          {(() => {
            ...
            <div
              className={classNames(
                ...
                sty.text___33E0W,
                {
                  [sty.textglobal_unnamedGlobalGroupOfVariants_unnamedVariant___33E0WYcZU]:
                    hasVariant(
                      globalVariants,
                      "unnamedGlobalGroupOfVariants",
                      "unnamedVariant"
          ...
          {(() => {
            ...
            <div
              className={classNames(projectcss.all, sty.freeBox__qMaxo, {
                [sty.freeBoxspecialized__qMaxo8RZr3]: hasVariant(
                  $state,
                  "specialized",
                  "specialized"
                )
            ...
            >
              {(_par => (!_par ? [] : Array.isArray(_par) ? _par : [_par]))(
                ...
                return (
                  <div
                    className={classNames(projectcss.all, sty.freeBox__hr7Et, {
                      [sty.freeBoxspecialized__hr7Et8RZr3]: hasVariant(
                        $state,
                        "specialized",
                        "specialized"
                      )
                  ...
                  >
                    <div
                      className={classNames(
                        ...
                        sty.freeBox__kmFpP,
                        {
                          [sty.freeBoxspecialized__kmFpP8RZr3]: hasVariant(
                            $state,
                            "specialized",
                            "specialized"
                          )
                    ...
                    >
                      <div
                        className={classNames(
                          ...
                          sty.freeBox__hdsNb,
                          {
                            [sty.freeBoxspecialized__hdsNb8RZr3]: hasVariant(
                              $state,
                              "specialized",
                              "specialized"
                            )
                      ...
                      >
                        {(() => {
                          ...
                          <PercentageBox
                            className={classNames(
                              "__wab_instance",
                              sty.percentageBox__n7LzD,
                              {
                                [sty.percentageBoxspecialized__n7LzD8RZr3]:
                                  hasVariant(
                                    $state,
                                    "specialized",
                                    "specialized"
                          ...
                          >
                            <div
                              className={classNames(
                                ...
                                sty.text__pRkb2,
                                {
                                  [sty.textspecialized__pRkb28RZr3]: hasVariant(
                                    $state,
                                    "specialized",
                                    "specialized"
                                  )
                            ...
                            <Icon127Icon
                              className={classNames(
                                ...
                                "animashen",
                                {
                                  [sty.svgspecialized__g09Sp8RZr3]: hasVariant(
                                    $state,
                                    "specialized",
                                    "specialized"
                                  )
                            ...
                            <div
                              className={classNames(
                                ...
                                sty.text__xeDeH,
                                {
                                  [sty.textspecialized__xeDeH8RZr3]: hasVariant(
                                    $state,
                                    "specialized",
                                    "specialized"
                                  )
      ...
      {(
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__lb3Ua, {
            [sty.freeBoxinformation__lb3UaNqecg]: hasVariant(
              $state,
              "information",
              "information"
            ),
            [sty.freeBoxspecialized__lb3Ua8RZr3]: hasVariant(
              $state,
              "specialized",
              "specialized"
            )
        ...
        >
          <div
            className={classNames(projectcss.all, sty.freeBox___98SxN, {
              [sty.freeBoxspecialized___98SxN8RZr3]: hasVariant(
                $state,
                "specialized",
                "specialized"
              )
          ...
          <div className={classNames(projectcss.all, sty.freeBox__ieS2V)}>
            <div
              className={classNames(
                projectcss.all,
                projectcss.__wab_text,
                sty.text___66Npm,
                {
                  [sty.textglobal_unnamedGlobalGroupOfVariants_unnamedVariant___66NpmYcZU]:
                    hasVariant(
                      globalVariants,
                      "unnamedGlobalGroupOfVariants",
                      "unnamedVariant"
                    ),
                  [sty.textspecialized___66Npm8RZr3]: hasVariant(
                    $state,
                    "specialized",
                    "specialized"
                  )
      ...
      <ApiRequest
        ...
        className={classNames("__wab_instance", sty.apiRequest, {
          ...
          [sty.apiRequestspecialized_dercentage]:
            hasVariant($state, "dercentage", "dercentage") &&
            hasVariant($state, "specialized", "specialized")
        })}
        errorDisplay={null}
        ...
        onSuccess={async (...eventArgs: any) => {
          ...
          (async data => {
            ...
            if (
              ...
              $steps["updateSpecialized2"] = await $steps["updateSpecialized2"];
            }
          }).apply(null, eventArgs);
        }}
        params={(() => {
        ...
        shouldFetch={(() => {
          try {
            return $state.userId != "" && $state.sessionId != "";
          } catch (e) {
            if (
              e instanceof TypeError ||
              e?.plasmicType === "PlasmicUndefinedDataError"
      ...
      {(
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox___2JsYo, {
            [sty.freeBoxspecialized___2JsYo8RZr3]: hasVariant(
              $state,
              "specialized",
              "specialized"
            )
        ...
        >
          <div
            className={classNames(
              ...
              sty.text__pRqz7,
              {
                [sty.textspecialized__pRqz78RZr3]: hasVariant(
                  $state,
                  "specialized",
                  "specialized"
                )
          ...
          <div className={classNames(projectcss.all, sty.freeBox__xRpVl)}>
            <div
              className={classNames(
                projectcss.all,
                projectcss.__wab_text,
      ...
      {(() => {
        ...
        <div className={classNames(projectcss.all, sty.freeBox___8Z4QO)}>
          <div
            className={classNames(
              projectcss.all,
              projectcss.__wab_text,
          ...
          <div className={classNames(projectcss.all, sty.freeBox__sTx64)}>
            {(_par => (!_par ? [] : Array.isArray(_par) ? _par : [_par]))(
              (() => {
                try {
                  return [5, 4, 3, 2, 1];
              ...
              return (
                <Stars
                  ...
                  className={classNames("__wab_instance", sty.stars__htPdh)}
                  key={currentIndex}
                  onClick={async event => {
                    const $steps = {};
                ...
                >
                  <div className={classNames(projectcss.all, sty.freeBox__h1O)}>
                    <div
                      className={classNames(
                        projectcss.all,
                        projectcss.__wab_text,
          ...
          <div className={classNames(projectcss.all, sty.freeBox__gcmRp)}>
            {false
              ? (() => {
                  const child$Props = {
                    autoSize: true,
          ...
          <Paziresh24Button
            ...
            className={classNames(
              "__wab_instance",
              sty.paziresh24Button__suUbk
            )}
            endIcon={
              <ChevronLeftIcon
                className={classNames(projectcss.all, sty.svg__rLyTx)}
                role={"img"}
              />
            }
            isDisabled={(() => {
            ...
            startIcon={
              <ChevronRightIcon
                className={classNames(projectcss.all, sty.svg__aRqEy)}
                role={"img"}
              />
            }
          />
          ...
          <Paziresh24Button
            ...
            className={classNames(
              "__wab_instance",
              sty.paziresh24Button__zHf4N
            )}
            endIcon={
              <ChevronLeftIcon
                className={classNames(projectcss.all, sty.svg___1ZFmI)}
                role={"img"}
              />
            }
            onClick={async event => {
            ...
            startIcon={
              <ChevronRightIcon
                className={classNames(projectcss.all, sty.svg__rCzHi)}
                role={"img"}
              />
            }
          />
      ...
      {(() => {
        ...
        <div className={classNames(projectcss.all, sty.freeBox__bCjzl)}>
          <Icon111Icon
            className={classNames(projectcss.all, sty.svg__pHGeX)}
            role={"img"}
          />
        </div>
      ) : null}
      <Paziresh24Modal
        ...
        body={
          <ApiRequest
            ...
            errorDisplay={null}
            loadingDisplay={
              <div className={classNames(projectcss.all, sty.freeBox__dcfmw)}>
                <Icon113Icon
                  className={classNames(projectcss.all, sty.svg___1XXn)}
                  role={"img"}
                />
              </div>
            }
          ...
          >
            <div className={classNames(projectcss.all, sty.freeBox__hiChi)}>
              <Alert
                className={classNames("__wab_instance", sty.alert__w5Yr4)}
                success={true}
                text={
              ...
              {(_par => (!_par ? [] : Array.isArray(_par) ? _par : [_par]))(
                ...
                return (
                  <div
                    className={classNames(projectcss.all, sty.freeBox__yHqtz)}
                    key={currentIndex}
                  >
                    <div
                      className={classNames(projectcss.all, sty.freeBox__aWnm0)}
                    >
                      <div
                        className={classNames(
                          projectcss.all,
                                        ...
                                        if (
                                          ...
                                          return (
                                            currentItem.expertises[0]?.degree
                                              ?.name +
                                            "-" +
                                            currentItem.expertises[0]?.expertise
                                              ?.name
                                          );
                                        } else if (
                            ...
                            >
                              ...
                              >
                                <React.Fragment>
                                  {(() => {
                                    try {
                                      return currentItem.satisfaction % 20 === 0
                    ...
                    <HamdastUtilsOpenLink
                      className={classNames(
                        "__wab_instance",
                        sty.hamdastUtilsOpenLink__ibD9O
                      )}
                      destination={(() => {
                        try {
                    ...
                    <HamdastUtilsOpenLink
                      className={classNames(
                        "__wab_instance",
                        sty.hamdastUtilsOpenLink___8F6I
                      )}
                      destination={
      ...
      {(() => {
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__aFab2, {
            [sty.freeBoxspecialized__aFab28RZr3]: hasVariant(
              $state,
              "specialized",
              "specialized"
            )
        ...
        >
          <div
            className={classNames(projectcss.all, sty.freeBox__hs8Yu, {
              [sty.freeBoxspecialized__hs8Yu8RZr3]: hasVariant(
                $state,
                "specialized",
                "specialized"
              )
          ...
          >
            <Icon118Icon
              className={classNames(projectcss.all, sty.svg___6Uf0B)}
              role={"img"}
            />
          ...
          <Paziresh24Button
            ...
            className={classNames(
              "__wab_instance",
              sty.paziresh24Button__jCcDk
            )}
            color={"softGreen"}
            endIcon={
              <Icon117Icon
                className={classNames(projectcss.all, sty.svg__nbEec)}
                role={"img"}
              />
            }
            onClick={async event => {
            ...
            startIcon={
              <ChevronRightIcon
                className={classNames(projectcss.all, sty.svg__j3XPb)}
                role={"img"}
              />
            }
          />
      ...
      {(() => {
        ...
        <section className={classNames(projectcss.all, sty.section__oPysc)}>
          <div
            className={classNames(projectcss.all, sty.freeBox__kwDI, {
              [sty.freeBoxglobal_unnamedGlobalGroupOfVariants_unnamedVariant__kwDIYcZU]:
                hasVariant(
                  globalVariants,
                  "unnamedGlobalGroupOfVariants",
                  "unnamedVariant"
          ...
          >
              ...
              ? (_par => (!_par ? [] : Array.isArray(_par) ? _par : [_par]))(
                  ...
                  return (
                    <Paziresh24Button
                      children2={
                        <div
                          className={classNames(
                            ...
                            sty.freeBox__niSfQ,
                            {
                              [sty.freeBoxspecialized__niSfQ8RZr3]: hasVariant(
                                $state,
                                "specialized",
                                "specialized"
                              )
                        ...
                        >
                          <div
                            className={classNames(
                              ...
                              sty.text__rvzfP,
                              {
                                [sty.textspecialized__rvzfP8RZr3]: hasVariant(
                                  $state,
                                  "specialized",
                                  "specialized"
                                )
                          ...
                          <div
                            className={classNames(
                              ...
                              sty.text__czQz6,
                              {
                                [sty.textspecialized__czQz68RZr3]: hasVariant(
                                  $state,
                                  "specialized",
                                  "specialized"
                                )
                      ...
                      className={classNames(
                        "__wab_instance",
                        sty.paziresh24Button__r0Yz,
                        {
                          [sty.paziresh24Buttonspecialized__r0Yz8RZr3]:
                            hasVariant($state, "specialized", "specialized")
                        }
                      )}
                      endIcon={
                        <Icon125Icon
                          className={classNames(projectcss.all, sty.svg__wEfXb)}
                          role={"img"}
                        />
                      }
                      key={currentIndex}
                      ...
                      startIcon={
                        <Icon125Icon
                          className={classNames(projectcss.all, sty.svg__dHncL)}
                          role={"img"}
                        />
                      }
                    />
              ...
              ? (_par => (!_par ? [] : Array.isArray(_par) ? _par : [_par]))(
                  ...
                  return (
                    <Paziresh24Button
                      ...
                      className={classNames(
                        "__wab_instance",
                        sty.paziresh24Button__xdMwV,
                        {
                          [sty.paziresh24Buttonspecialized__xdMwV8RZr3]:
                            hasVariant($state, "specialized", "specialized")
                        }
                      )}
                      endIcon={
                        <Icon125Icon
                          className={classNames(projectcss.all, sty.svg__marPx)}
                          role={"img"}
                        />
                      }
                      key={currentIndex}
              ...
              ? (_par => (!_par ? [] : Array.isArray(_par) ? _par : [_par]))(
                  ...
                  return (
                    <Paziresh24Button
                        ...
                        >
                          <div
                            className={classNames(
                              ...
                              sty.text__kPlT,
                              {
                                [sty.textspecialized__kPlT8RZr3]: hasVariant(
                                  $state,
                                  "specialized",
                                  "specialized"
                                )
                      ...
                      className={classNames(
                        "__wab_instance",
                        sty.paziresh24Button__mmyP5,
                        {
                          [sty.paziresh24Buttondercentage__mmyP5HpnJh]:
                            hasVariant($state, "dercentage", "dercentage"),
                          [sty.paziresh24Buttonspecialized__mmyP58RZr3]:
                            hasVariant($state, "specialized", "specialized"),
                          [sty.paziresh24Buttonspecialized_dercentage__mmyP58RZr3HpnJh]:
                            hasVariant($state, "dercentage", "dercentage") &&
                            hasVariant($state, "specialized", "specialized")
                        }
                      )}
                      endIcon={
                        <Icon125Icon
                          className={classNames(projectcss.all, sty.svg__j8V2D)}
                          role={"img"}
                        />
                      }
                      key={currentIndex}
                        ...
                        $steps["runCode"] = $state.prescriptions.find(
                          ...
                          ? (() => {
                              const actionArgs = {
                                customFunction: async () => {
                                  return window.open(
                                    `https://tools.liom.app/medicine/?code=${$state.prescriptions.find(i => i.request_p == "نسخه دارو" && i.done == 1).doctor_tracking_code}`,
                                    "_self"
                                  );
                                }
                              };
                      ...
                      startIcon={
                        <Icon142Icon
                          className={classNames(projectcss.all, sty.svg__r2Nkl)}
                          role={"img"}
                        />
                      }
                    />
            ...
            <Paziresh24Button
              children2={
                <Icon124Icon
                  className={classNames(projectcss.all, sty.svg__zfRmo)}
                  role={"img"}
                />
              }
              className={classNames(
                "__wab_instance",
                sty.paziresh24Button___5Zr1K
              )}
              endIcon={
                <ChevronLeftIcon
                  className={classNames(projectcss.all, sty.svg__sxKi)}
                  role={"img"}
                />
              }
              onClick={async event => {
      ...
      <Paziresh24Modal
        ...
        body={
          <div className={classNames(projectcss.all, sty.freeBox__gTfny)}>
            <div className={classNames(projectcss.all, sty.freeBox___4IT5F)}>
              {(_par => (!_par ? [] : Array.isArray(_par) ? _par : [_par]))(
                (() => {
                  try {
                    return [5, 4, 3, 2, 1];
                ...
                return (
                  <Stars
                    ...
                    className={classNames("__wab_instance", sty.stars__ckBv9)}
                    key={currentIndex}
                    onClick={async event => {
                      const $steps = {};
                  ...
                  >
                    <div
                      className={classNames(projectcss.all, sty.freeBox__p4Qum)}
                    >
                      <div
                        className={classNames(
                          projectcss.all,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__d14Ck)}>
              {(() => {
                const child$Props = {
                  autoSize: true,
              ...
              {(() => {
                ...
                <div
                  className={classNames(projectcss.all, sty.freeBox__rlg0O)}
                  onClick={async event => {
                    const $steps = {};
            ...
            <Paziresh24Button
              ...
              className={classNames(
                "__wab_instance",
                sty.paziresh24Button___7M4PC
              )}
              endIcon={
                <ChevronLeftIcon
                  className={classNames(projectcss.all, sty.svg__oeZzy)}
                  role={"img"}
                />
              }
              isDisabled={(() => {
              ...
              startIcon={
                <ChevronRightIcon
                  className={classNames(projectcss.all, sty.svg__txZh3)}
                  role={"img"}
                />
              }
            />
      ...
      <Paziresh24Modal
        ...
        body={
          <div className={classNames(projectcss.all, sty.freeBox__aoJo)}>
            <RadioGroup
              ...
              options={
                <div className={classNames(projectcss.all, sty.freeBox__tJ3Ez)}>
                  <Radio
                    className={classNames("__wab_instance", sty.radio__tiWje)}
                    label={"\u0628\u0631\u0627\u06cc \u062e\u0648\u062f\u0645"}
                    value={"false"}
                  />

                  <Radio
                    className={classNames("__wab_instance", sty.radio___05Qjr)}
                    label={
                      "\u0628\u0631\u0627\u06cc \u062f\u06cc\u06af\u0631\u06cc"
                    }
                    value={"true"}
            ...
            <div className={classNames(projectcss.all, sty.freeBox__fsAkm)}>
              <div className={classNames(projectcss.all, sty.freeBox__gCq7O)}>
                <TextInput
                ...
                >
                  <div
                    className={classNames(projectcss.all, sty.freeBox__s367C)}
                  >
                    <div
                      className={classNames(
                        projectcss.all,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__ck7Ul)}>
                <TextInput
                  ...
                  error={(() => {
                    try {
                      return $state.errors.find(item => item.type == "lastName")
                        ? true
                        : false;
                    } catch (e) {
                      if (
                ...
                >
                  <div
                    className={classNames(projectcss.all, sty.freeBox__iioLv)}
                  >
                    <div
                      className={classNames(
                        projectcss.all,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__nIoP)}>
              <TextInput
              ...
              <div className={classNames(projectcss.all, sty.freeBox___1GgXa)}>
                <div
                  className={classNames(
                    projectcss.all,
                    projectcss.__wab_text,
            ...
            <div className={classNames(projectcss.all, sty.freeBox___9EL8)}>
              <TextInput
            ...
            <div className={classNames(projectcss.all, sty.freeBox__n0C1P)}>
              <div
              ...
              >
                ...
                >
                  <React.Fragment>
                    {(() => {
                      try {
                        return $state.errors.find(item => item.type == "gender")
                          .message;
                      } catch (e) {
                        if (
                          e instanceof TypeError ||
            ...
            <div className={classNames(projectcss.all, sty.freeBox__kQqlG)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__dR8Pz)}>
                {(() => {
                  const child$Props = {
                    autoSize: false,
            ...
            <ButtonLiom
              ...
              onClick={async event => {
                      ...
                      const actionArgs = {
                        customFunction: async () => {
                          return (() => {
                            ...
                            } else if (!/^\d{10}$/.test($state.code?.value)) {
                              errors.push({
                                type: "nationalCode",
                            ...
                            } else if (!/^09\d{9}$/.test($state.mobile.value)) {
                              errors.push({
                                type: "phoneNumber",
                ...
                if (
                  ...
                  $steps["updateButtonLiom5Load"] =
                    await $steps["updateButtonLiom5Load"];
                }
        ...
        title={
          <div
            className={classNames(
              ...
              sty.text___4Hx6F,
              {
                [sty.textdercentage___4Hx6FHpnJh]: hasVariant(
                  $state,
                  "dercentage",
                  "dercentage"
                )
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__n09XY, {
          [sty.freeBoxspecialized__n09XY8RZr3]: hasVariant(
            $state,
            "specialized",
            "specialized"
          )
      ...
      <section
        className={classNames(projectcss.all, sty.section__jLoSi, {
          [sty.sectionspecialized__jLoSi8RZr3]: hasVariant(
            $state,
            "specialized",
            "specialized"
          )
      ...
      >
        <ButtonLiom
                  ...
                  const actionArgs = {
                    customFunction: async () => {
                      return (() => {
                        ...
                        const newUrl = `${currentUrl.origin}/self-test?${params.toString()}`;
          ...
          startIcon={
            <Icon136Icon
              className={classNames(projectcss.all, sty.svg__aPGvH)}
              role={"img"}
            />
          }
        >
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicResultComponnent__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicResultComponnent__VariantsArgs, ReservedPropsType> &
    // Specify args directly as props
    Omit<PlasmicResultComponnent__ArgsType, ReservedPropsType> &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicResultComponnent__ArgProps,
          internalVariantPropNames: PlasmicResultComponnent__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicResultComponnent__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicResultComponnent";
  } else {
    func.displayName = `PlasmicResultComponnent.${nodeName}`;
  }
  return func;
}

export const PlasmicResultComponnent = Object.assign(
  // Top-level PlasmicResultComponnent renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicResultComponnent
    internalVariantProps: PlasmicResultComponnent__VariantProps,
    internalArgProps: PlasmicResultComponnent__ArgProps
  }
);

export default PlasmicResultComponnent;
/* prettier-ignore-end */
