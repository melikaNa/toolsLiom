...
import sty from "./PlasmicMenuPopover.module.css"; // plasmic-import: pSBZTjbJHcwD/css
            ...
            {renderPlasmicSlot({
              defaultContents: (
                <React.Fragment>
                  ...
                  <MenuItem
                    className={classNames("__wab_instance", sty.menuItem__uSmH)}
                    label={"Item 2"}
                    value={"item2"}
                  />
