...
import sty from "./PlasmicRadio.module.css"; // plasmic-import: -mvxyQjykw-c/css
...
function PlasmicRadio__RenderFunc(props: {
  ...
  return (
    <BaseRadio
      ...
      value={args.value}
    >
      <div className={classNames(projectcss.all, sty.freeBox__bx9En)}>
        <div className={classNames(projectcss.all, sty.freeBox__vqG8R)} />
      </div>
      {renderPlasmicSlot({
