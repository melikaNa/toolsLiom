...
export type EmojiSadSquareSvgrepoComSvgIconProps =
  React.ComponentProps<"svg"> & {
    title?: string;
  };

export function EmojiSadSquareSvgrepoComSvgIcon(
  props: EmojiSadSquareSvgrepoComSvgIconProps
) {
...
export default EmojiSadSquareSvgrepoComSvgIcon;
/* prettier-ignore-end */
