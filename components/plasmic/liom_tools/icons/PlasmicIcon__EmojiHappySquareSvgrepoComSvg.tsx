...
export type EmojiHappySquareSvgrepoComSvgIconProps =
  React.ComponentProps<"svg"> & {
    title?: string;
  };

export function EmojiHappySquareSvgrepoComSvgIcon(
  props: EmojiHappySquareSvgrepoComSvgIconProps
) {
...
export default EmojiHappySquareSvgrepoComSvgIcon;
/* prettier-ignore-end */
