    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__nkIc, {
          ...
          [sty.freeBoxsize_short__nkIcuLe5D]: hasVariant(
            $state,
            "size",
            "short"
          )
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__laz28, {
          [sty.freeBox___focusVisibleWithin__laz289XNfi]:
            triggers.focusVisibleWithin_root,
          [sty.freeBoxcolor_dark__laz287EHn]: hasVariant(
            $state,
            "color",
            "dark"
          ),
          ...
          [sty.freeBoxshowStartIcon__laz28Ue2Gv]: hasVariant(
            $state,
            "showStartIcon",
            "showStartIcon"
          ),
          [sty.freeBoxsize_longh__laz28JzAcp]: hasVariant(
            $state,
            "size",
            "longh"
          ),
          [sty.freeBoxsize_medium__laz28QLn2R]: hasVariant(
            $state,
            "size",
            "medium"
          ),
      ...
      >
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <SearchSvgIcon
                className={classNames(projectcss.all, sty.svg__zIcxm)}
                role={"img"}
              />
            ),
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CheckSvgIcon
                className={classNames(projectcss.all, sty.svg__sSZuq)}
                role={"img"}
              />
            ),
