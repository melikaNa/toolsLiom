...
import sty from "./PlasmicCountdownNumber.module.css"; // plasmic-import: xzpsChHOVqpk/css
...
function PlasmicCountdownNumber__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__mczAq)}>
        {renderPlasmicSlot({
          defaultContents: "42",
          value: args.number,
      ...
      <div className={classNames(projectcss.all, sty.freeBox___8UGrB)}>
        {renderPlasmicSlot({
