...
import { _useStyleTokens } from "./PlasmicStyleTokensProvider"; // plasmic-import: 9yPKYrtYPnCNEj6BTTfHnY/styleTokensProvider

import "@plasmicapp/react-web/lib/plasmic.css";

import projectcss from "./plasmic.module.css"; // plasmic-import: 9yPKYrtYPnCNEj6BTTfHnY/projectcss
import sty from "./PlasmicPaziresh24Button.module.css"; // plasmic-import: 5Yh7dJ5JJS2f/css

import ChevronRightIcon from "./icons/PlasmicIcon__ChevronRight"; // plasmic-import: ehuYANk-vbAX/icon
import Icon17Icon from "./icons/PlasmicIcon__Icon17"; // plasmic-import: jii3Qg8_xpwy/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: 9erlu8peqbPE/icon
import ChevronLeftIcon from "./icons/PlasmicIcon__ChevronLeft"; // plasmic-import: TyihT0qbU5hB/icon
      ...
      className={classNames(
        ...
        sty.root,
        {
          ...
          [sty.rootcolor_red____focusVisibleWithin]:
            ...
            triggers.focusVisibleWithin_root,
          [sty.rootcolor_red____focusVisibleWithin_outline]:
            hasVariant($state, "color", "red") &&
            hasVariant($state, "outline", "outline") &&
            triggers.focusVisibleWithin_root,
          ...
          [sty.rootloading_showStartIcon]:
            hasVariant($state, "loading", "loading") &&
            hasVariant($state, "showStartIcon", "showStartIcon"),
          [sty.rootloading_showStartIcon_outline]:
            hasVariant($state, "outline", "outline") &&
            hasVariant($state, "loading", "loading") &&
            hasVariant($state, "showStartIcon", "showStartIcon"),
      ...
      {(
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronRightIcon
                className={classNames(projectcss.all, sty.svg___2Yqi)}
                role={"img"}
              />
            ),
          ...
          <PlasmicIcon__
            ...
            className={classNames(projectcss.all, sty.svg, "loader", {
              ...
              [sty.svgcolor_link_loading]:
                hasVariant($state, "loading", "loading") &&
                hasVariant($state, "color", "link"),
              [sty.svgcolor_link_loading_outline]:
                hasVariant($state, "loading", "loading") &&
                hasVariant($state, "outline", "outline") &&
                hasVariant($state, "color", "link"),
            ...
            ? renderPlasmicSlot({
                ...
                className: classNames(sty.slotTargetChildren2, {
                  ...
                  [sty.slotTargetChildren2color_red_outline]:
                    hasVariant($state, "color", "red") &&
                    hasVariant($state, "outline", "outline"),
                  [sty.slotTargetChildren2color_red_shape_rounded_outline]:
                    hasVariant($state, "outline", "outline") &&
                    hasVariant($state, "color", "red") &&
                    hasVariant($state, "shape", "rounded"),
      ...
      {(
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronLeftIcon
                className={classNames(projectcss.all, sty.svg__xdOrX)}
                role={"img"}
              />
            ),
...
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicPaziresh24Button__VariantsArgs, ReservedPropsType> &
