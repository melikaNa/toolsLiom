...
import Paziresh24Button from "../../Paziresh24Button"; // plasmic-import: 5Yh7dJ5JJS2f/component
...
import sty from "./PlasmicPaziresh24Dialog.module.css"; // plasmic-import: 3EjQUDnmYfrf/css
...
import XIcon from "./icons/PlasmicIcon__X"; // plasmic-import: S0M2VMEAEs7X/icon
  ...
  return (
    <Dialog
      ...
      overlayClassName={classNames({
        [sty["pcls_EwstK7Tt_D-8"]]: hasVariant(
          globalVariants,
          "screen",
          "mobileOnly"
        ),
        [sty["pcls_ub0AiXe6HO20"]]: true
      })}
          ...
          ? renderPlasmicSlot({
              defaultContents: (
                <Paziresh24Button
                  ...
                  endIcon={
                    <ChevronLeftIcon
                      className={classNames(projectcss.all, sty.svg__sbEm5)}
                      role={"img"}
                    />
                  }
                  startIcon={
                    <ChevronRightIcon
                      className={classNames(projectcss.all, sty.svg__zAr5O)}
                      role={"img"}
                    />
                  }
                />
    ...
    >
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__jWe3D)}
          dir={"rtl"}
        >
          <DialogTitle
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__xzIxF)}
          dir={"rtl"}
        >
          {renderPlasmicSlot({
            defaultContents: (
...
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicPaziresh24Dialog__VariantsArgs, ReservedPropsType> &
